...
import { FullViewControl } from './components/header/FullViewControl';
  ...
  return (
    <header className="h-16 border-b border-[var(--kilang-border)] bg-[var(--kilang-bg-base)]/80 backdrop-blur-md flex items-center justify-between z-[150] shrink-0">
      ...
      {!state.hideCanvasControls ? (
        ...
        <div className="flex-1 min-w-0 flex items-center justify-center h-full relative">
           <BreadcrumbPath />
        </div>
      )}
