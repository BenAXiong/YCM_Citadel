...
import { X, RotateCcw, SlidersHorizontal, PencilLine, Box, Scaling, Palette, Circle, Triangle, Zap, ZapOff } from 'lucide-react';
...
export const KilangToolbox = ({ layoutConfig, dispatch }: KilangToolboxProps) => {
  ...
  return (
    <div className="absolute top-6 left-6 w-72 bg-[#0f172a]/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl z-[5001] flex flex-col overflow-hidden animate-in fade-in slide-in-from-left-4 duration-500">
      {/* Header */}
      ...
      {/* Content */}
      {!isCollapsed && (
        <div className="p-4 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar animate-in fade-in slide-in-from-top-2 duration-300">
          {/* 1. Spacing & Paths */}
