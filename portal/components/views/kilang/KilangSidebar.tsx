...
const KilangSidebarInner = ({ isCollapsed, onToggle }: KilangSidebarProps) => {
  ...
  return (
    <aside
      className={`h-full border-r border-[var(--kilang-border-std)] flex flex-col kilang-glass-panel relative z-50 group/sidebar ${isResizing ? '' : 'transition-all duration-300'}`}
