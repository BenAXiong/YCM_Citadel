...
import { Activity, RefreshCw, TreePine, ChevronRight, Minimize2, Maximize2, Minus, Plus, RotateCcw, ArrowRight, ArrowUp, LayoutGrid, Rows, ChevronDown, Download, FileText, ImageIcon } from 'lucide-react';
        ...
        <div className="flex-1 kilang-glass-panel rounded-3xl overflow-hidden relative flex flex-col border border-white/10 shadow-2xl">
          ...
          {moveCaptureToCanvas && selectedRoot && !exporting && (
            <div className="absolute bottom-6 left-6 z-[110]" ref={exportRef}>
              ...
              {/* Sync of Export Settings Dropdown logic - styled for canvas */}
              {showExportDropdown && (
