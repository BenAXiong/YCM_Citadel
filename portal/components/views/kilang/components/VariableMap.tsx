...
const VARIABLE_MANIFEST: Record<string, { count: number, files: string[], group: 'surface' | 'border' | 'text' }> = {
  "--kilang-accent": { group: 'surface', count: 4, files: ["KilangHeader.tsx","KilangNode.tsx","KilangRightSidebar.tsx","kilangReducer.ts"] },
  "--kilang-accent-bg": { group: 'surface', count: 3, files: ["components\\ThemeBar.tsx"] },
  "--kilang-accent-border": { group: 'border', count: 3, files: ["components\\ThemeBar.tsx"] },
  "--kilang-accent-glow": { group: 'surface', count: 3, files: ["components\\ThemeBar.tsx"] },
  "--kilang-accent-text": { group: 'text', count: 7, files: ["KilangNode.tsx","KilangRightSidebar.tsx","components\\CompactMetric.tsx","components\\ThemeBar.tsx"] },
  "--kilang-background-secondary": { group: 'surface', count: 1, files: ["components\\SidebarUI.tsx"] },
  "--kilang-bg": { group: 'surface', count: 7, files: ["KilangCanvas.tsx","KilangExportHUD.tsx","KilangNode.tsx","components\\ThemeBar.tsx"] },
  "--kilang-bg-base": { group: 'surface', count: 35, files: ["KilangCanvas.tsx","KilangExportHUD.tsx","KilangHeader.tsx","KilangNode.tsx","KilangRightSidebar.tsx","KilangSidebar.tsx","components\\CustomTab.tsx","components\\ForestControls.tsx","components\\ThemeBar.tsx"] },
  "--kilang-border": { group: 'border', count: 12, files: ["KilangHeader.tsx","KilangNode.tsx","components\\SidebarUI.tsx","components\\ThemeBar.tsx"] },
  "--kilang-border-std": { group: 'border', count: 37, files: ["KilangCanvas.tsx","KilangExportHUD.tsx","KilangHeader.tsx","KilangRightSidebar.tsx","KilangSidebar.tsx","components\\CompactMetric.tsx","components\\CustomTab.tsx","components\\ForestControls.tsx","components\\RootList.tsx","components\\ThemeBar.tsx"] },
  ...
  "--kilang-ctrl-active": { group: 'surface', count: 46, files: ["KilangCanvas.tsx","KilangHeader.tsx","KilangRightSidebar.tsx","KilangSidebar.tsx","components\\CustomTab.tsx","components\\ForestControls.tsx","components\\RootList.tsx","components\\StylingTab.tsx","components\\ThemeBar.tsx"] },
  "--kilang-ctrl-active-border": { group: 'border', count: 5, files: ["components\\ThemeBar.tsx"] },
  "--kilang-ctrl-active-text": { group: 'text', count: 26, files: ["KilangHeader.tsx","KilangRightSidebar.tsx","KilangSidebar.tsx","components\\CustomTab.tsx","components\\ForestControls.tsx","components\\RootList.tsx","components\\StylingTab.tsx","components\\ThemeBar.tsx"] },
  ...
  "--kilang-primary": { group: 'surface', count: 80, files: ["AffixesOverlay.tsx","KilangCanvas.tsx","KilangHeader.tsx","KilangNode.tsx","KilangRightSidebar.tsx","KilangSidebar.tsx","components\\BookmarkLibrary.tsx","components\\CustomTab.tsx","components\\ForestControls.tsx","components\\RootList.tsx","components\\ThemeBar.tsx","kilangReducer.ts"] },
  "--kilang-primary-active": { group: 'surface', count: 1, files: ["KilangNode.tsx"] },
  ...
  "--kilang-primary-border": { group: 'border', count: 13, files: ["KilangHeader.tsx","KilangNode.tsx","KilangRightSidebar.tsx","components\\ForestControls.tsx","components\\ThemeBar.tsx"] },
  "--kilang-primary-glow": { group: 'surface', count: 19, files: ["KilangCanvas.tsx","KilangHeader.tsx","KilangNode.tsx","KilangRightSidebar.tsx","components\\ForestControls.tsx","components\\RootList.tsx","components\\ThemeBar.tsx"] },
  "--kilang-primary-text": { group: 'text', count: 21, files: ["KilangHeader.tsx","KilangNode.tsx","KilangRightSidebar.tsx","components\\CompactMetric.tsx","components\\ForestControls.tsx","components\\RootList.tsx","components\\ThemeBar.tsx"] },
  "--kilang-radius-lg": { group: 'surface', count: 1, files: ["KilangNode.tsx"] },
  "--kilang-resizer-active": { group: 'surface', count: 1, files: ["KilangSidebar.tsx"] },
  "--kilang-resizer-hover": { group: 'surface', count: 1, files: ["KilangSidebar.tsx"] },
  "--kilang-scrollbar-border": { group: 'border', count: 3, files: ["components\\ThemeBar.tsx"] },
  "--kilang-secondary": { group: 'surface', count: 14, files: ["KilangHeader.tsx","KilangNode.tsx","components\\BookmarkLibrary.tsx","components\\CustomTab.tsx","components\\ForestControls.tsx","kilangReducer.ts"] },
  "--kilang-secondary-bg": { group: 'surface', count: 4, files: ["components\\ForestControls.tsx","components\\ThemeBar.tsx"] },
  "--kilang-secondary-border": { group: 'border', count: 4, files: ["components\\ForestControls.tsx","components\\ThemeBar.tsx"] },
  "--kilang-secondary-glow": { group: 'surface', count: 5, files: ["components\\ForestControls.tsx","components\\ThemeBar.tsx"] },
  "--kilang-secondary-text": { group: 'text', count: 13, files: ["KilangRightSidebar.tsx","components\\CompactMetric.tsx","components\\ForestControls.tsx","components\\ThemeBar.tsx"] },
  "--kilang-shadow-primary": { group: 'surface', count: 5, files: ["KilangRightSidebar.tsx","KilangSidebar.tsx","components\\CustomTab.tsx"] },
  "--kilang-text": { group: 'text', count: 78, files: ["KilangCanvas.tsx","KilangExportHUD.tsx","KilangHeader.tsx","KilangNode.tsx","KilangRightSidebar.tsx","KilangSidebar.tsx","components\\CustomTab.tsx","components\\ForestControls.tsx","components\\RootList.tsx","components\\SidebarUI.tsx","components\\StylingTab.tsx","components\\ThemeBar.tsx"] },
  "--kilang-text-muted": { group: 'text', count: 85, files: ["KilangCanvas.tsx","KilangExportHUD.tsx","KilangHeader.tsx","KilangNode.tsx","KilangRightSidebar.tsx","KilangSidebar.tsx","components\\CompactMetric.tsx","components\\CustomTab.tsx","components\\ForestControls.tsx","components\\RootList.tsx","components\\SidebarUI.tsx","components\\StylingTab.tsx","components\\ThemeBar.tsx"] },
  ...
  "--kilang-tooltip-accent": { group: 'surface', count: 1, files: ["KilangNode.tsx"] },
